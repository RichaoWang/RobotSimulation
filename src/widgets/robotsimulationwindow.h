...
//        });
    ...
    void makeDesignGuidanceNavItem() {
        FluVNavigationIconTextItem *item = new FluVNavigationIconTextItem(FluAwesomeType::Design, "Design guidance",
                                                                          this);
        FluVNavigationIconTextItem *item1 = new FluVNavigationIconTextItem(FluAwesomeType::FontSize, "Typography",
                                                                           item);
        FluVNavigationIconTextItem *item2 = new FluVNavigationIconTextItem(FluAwesomeType::EmojiTabSymbols, "Icons",
                                                                           item);
...
//        });
    ...
    void makeBasicInputNavItem() {
        FluVNavigationIconTextItem *item = new FluVNavigationIconTextItem(FluAwesomeType::CheckboxComposite,
                                                                          "Basic input", this);
...
//        item->addItem(item15);
    ...
    void makeCollectionsNavItem() {
        FluVNavigationIconTextItem *item = new FluVNavigationIconTextItem(FluAwesomeType::TiltDown, "Connections",
                                                                          this);
...
//        item->addItem(item7);
    ...
    void makDateTimeNavItem() {
        FluVNavigationIconTextItem *item = new FluVNavigationIconTextItem(FluAwesomeType::Calendar, "Date & time",
                                                                          this);
...
//        item->addItem(item4);
    ...
    void makeDialogsFlyouts() {
        FluVNavigationIconTextItem *item = new FluVNavigationIconTextItem(FluAwesomeType::Comment, "Dialogs & flyouts",
                                                                          this);
        item->setKey("");
...
//        connect(item, &FluVNavigationSettingsItem::itemClicked, [=]() { m_sLayout->setCurrentWidget("SettingPage"); });
    ...
    void makeMenuToolBarsNavItem() {
        FluVNavigationIconTextItem *item = new FluVNavigationIconTextItem(FluAwesomeType::Save, "Menus & toolbars",
                                                                          this);
...
//        item->addItem(item7);
    ...
    void makeNavigationNavItem() {
        FluVNavigationIconTextItem *item = new FluVNavigationIconTextItem(FluAwesomeType::BookmarksMirrored,
                                                                          "Navigation", this);
...
//        m_sLayout->addWidget("PivotPage", pivotPage);
    ...
    void makeStatusInfoNavItem() {
        FluVNavigationIconTextItem *item = new FluVNavigationIconTextItem(FluAwesomeType::Reminder, "Status & info",
                                                                          this);
