...
FluAEmptyPage2::FluAEmptyPage2(QWidget* parent /*= nullptr*/) : FluWidget(parent)
{
    ...
    m_titleLabel->setObjectName("titleLabel2");
    m_titleLabel->setText("CodeEdit");
    ...
    m_vScrollView->setObjectName("vScrollView2");
    ...
    m_infoLabel->setText(
        ...
        "Semibold.");
    m_infoLabel->setObjectName("infoLabel2");
...
void FluAEmptyPage2::paintEvent(QPaintEvent* event)
{
    QStyleOption opt;
    opt.initFrom(this);
